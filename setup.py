...
def list_cpp_files(package_dir='wikidata2vec'):
...
setup(
    name='wikidata2vec',
    version='1.0.0',
    description='A tool for learning vector representations of words and entities from Wikidata',
    ...
    entry_points={
        'console_scripts': [
            'wikidata2vec=wikidata2vec.cli:cli',
        ]
    },
    keywords=['wikidata', 'embedding', 'wikidata2vec'],
    classifiers=[
