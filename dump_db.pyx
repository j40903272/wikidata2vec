...
cdef class Entity:
    def __init__(self, unicode qid, unicode label, unicode description, unicode type, list alias):
        self.qid = qid
        self.label = label
    ...
    def __reduce__(self):
        return (self.__class__, (self.qid, self.label, self.description, self.type, self.alias))
